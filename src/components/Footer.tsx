...
import { TextHoverEffect } from "@/components/magicui/text-hover-effect"
...
const Footer = () => {
	return (
		<footer className="relative border-t border-gray-300">
				...
				<div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
					...
					<div>
						...
						<p className="text-gray-600 text-sm leading-relaxed mb-6">
							Advance your engineering skills with world-class courses and mentorship from industry experts.
						</p>
			...
			{/* Bottom Section with Navigation Links and Social Media */}
			...
			<div className="hidden lg:block absolute bottom-0 left-0 right-0 overflow-hidden pointer-events-none">
				<div className="h-32 flex items-center justify-center opacity-5">
					<TextHoverEffect text="SKILLFORGE" />
				</div>
			</div>
		</footer>
	)
